...
const Job = {
	async init(){
			...
			let setup_scripts = shell.exec('cd /root/automation_scripts/autotrader && npm i  && cd /root/automation_scripts/adesa && npm i && cd /root/automation_scripts/airtable && npm i ', {async:true});
